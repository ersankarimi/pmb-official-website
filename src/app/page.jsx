...
const Home = () => (
  <>
    <section className="relative grid grid-cols-1 grid-rows-[max-content_1fr] gap-12 md:grid-rows-none lg:grid-cols-[1fr_1fr] xl:grid-cols-[1.25fr_1fr] 2xl:grid-cols-[1.5fr_1fr]">
    ...
    <section className="relative grid grid-cols-1 grid-rows-[max-content_1fr] items-center gap-12 overflow-hidden rounded-2xl bg-inquares-hippie-green-300 p-4 lg:grid-cols-2 lg:grid-rows-1 lg:py-12">
